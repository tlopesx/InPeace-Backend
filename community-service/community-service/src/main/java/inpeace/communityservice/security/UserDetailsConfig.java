package inpeace.communityservice.security;

import inpeace.communityservice.dao.UserRepository;
...
public class UserDetailsConfig implements UserDetailsService{
    ...
    public CustomUser loadUserByUsername(String emailAddress) throws UsernameNotFoundException {
        inpeace.communityservice.model.User user = userRepository.findByEmailAddress(emailAddress)
